...
<Navbar let:hidden let:toggle>
  ...
  <NavUl {hidden}>
      ...
      <NavLi><Chevron aligned>Online Courses</Chevron></NavLi>
      <MegaMenu full items={courses} let:item>
      ...
      <NavLi><Chevron aligned>Services</Chevron></NavLi>
      <MegaMenu full items={services} let:item>
